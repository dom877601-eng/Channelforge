        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-300">
              ...
              channel. No fluff. No freelancer coordination. Just campaigns that
              ship and numbers you can actually use.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                ...
                onClick={() =>
                  capturePostHog("channelforge_hero_cta_clicked", {
      ...
      <section className="bg-gradient-to-r from-brand-900 to-brand-800 py-20 sm:py-28">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-gray-300">
            ...
            identify gaps, and show you what's possible — no pitch, no pressure.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              to="/contact"
